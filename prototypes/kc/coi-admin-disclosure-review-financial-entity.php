...
<body id="Uif-Application">
    ...
    <form id="kualiForm" action="../kr-krad/uicomponents" method="post" accept-charset="UTF-8">
            ...
            <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container-fluid">
                ...
                <main class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="" style="margin-left: 250px;">
                    ...
                    <div id="my-tab-content" class="tab-content">
                        <div class="tab-pane" id="review-project">
                            <div class="uif-header-inner">
                            ...
                            <table class="table table-condensed table-bordered uif-has-actions uif-lightTable dataTable bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <small>
                                                ...
                                                <a href="#">
                                                    (See All Reviewer Recommendations) 
                                                </a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-toggle="modal" data-target="#admin-relationships" class="">
                        ...
                        <!--  Review by Financial Entity -->
                        <div class="tab-pane  active" id="review-financial-entity">
                            <div class="uif-header-inner">
                                <h3 class="uif-headerText">
                                    <span class="uif-headerText-span">
                                        Review by Financial Entity 
                    ...
                    <div class="uif-viewContentWrapper container-fluid">
                        <!-- VIEW NAVIGATION -->
                    </div>
                </main>
            </div>
        ...
        <div class="uif-footer clearfix uif-stickyFooter uif-stickyButtonFooter" data-sticky_footer="true" data-parent="LabsProposal" style="position:fixed; left: 0; bottom: 0px;">
            ...
            <div class="global-actions btn-group">
                <button type="button" href="coi-admin-disclosure-list.php" class="btn btn-disabled">Route to COI Office</button>
            </div>
            <div class="global-actions btn-group">
                <button type="button" href="coi-admin-disclosure-list.php" class="btn btn-default">Assign Reviewer</button>
            </div>
            <div class="global-actions btn-group">
                <button type="button" href="coi-admin-disclosure-list.php" class="btn btn-default">Return to Reporter</button>
            </div>
            <div class="global-actions btn-group">
                <button type="button" href="coi-admin-disclosure-list.php" class="btn btn-default">Approve</button>
            </div>
        </div>
    </form>
...
<!-- MODAL INCLUDES -->
<?php include ('includes/modals-coi/admin-relationships.php') ?>
