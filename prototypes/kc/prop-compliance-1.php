...
<form id="kualiForm" action="../kr-krad/uicomponents" method=post accept-charset=UTF-8>
        ...
        <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container-fluid"><!-- VIEW NAVIGATION -->
                ...
                <div class="uif-header-inner">
                        <h2 id="" class="uif-headerText"> <span class="uif-headerText-span"> Compliance </span> </h2>
                        <div id="" class="uif-horizontalBoxGroup uif-header-rightGroup clearfix" data-parent="">
                        <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-add-compliance"><span aria-hidden="true" class="icon-plus"></span> Add Compliance Protocol</button>
                    </div>
                    </div>
                <table class="table table-condensed uif-has-actions">
                        ...
                        <tr>
                                ...
                                <td>Approved</td>
                                <td>#1124621</td>
                                <td><a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-edit-compliance">Details</a> <a href="#" class="btn btn-default btn-xs" data-toggle=""><span class="sr-only">Delete</span> <span aria-hidden="true" class="icon-trash"></span></a></td>
                            </tr> <tr>
                                <td>Animal Usage</td>
                                <td>Approved</td>
                                <td>#1271435</td>
        ...
        <div id="" class="uif-footer clearfix uif-stickyFooter uif-stickyButtonFooter" data-sticky_footer="true" data-parent="LabsProposal" style="position:fixed; left: 0; bottom: 0px;"> <div class="global-navigate btn-group">
                <button type="button" href="prop-personnel-credit.php" id="" class="btn btn-default"><span class="icon-chevron-left"></span> Back</button>
                <button type="button" href="prop-attachments.php" id="save-continue" class="btn btn-primary">Continue <span class="icon-chevron-right"></span></button>
            </div>       <!--        
...
<!-- MODAL COMPLIANCE -->
<?php include('includes/modals-prop/compliance-add.php') ?>
<?php include('includes/modals-prop/compliance-edit.php') ?>
