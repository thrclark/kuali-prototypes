<nav id="Uif-Navigation">
    <div id="Uif-NavigationMenu" class="uif-menuNavigationGroup">
        ...
        <ul class="nav nav-list">
            ...
            <li <?php if ($page == 'budgets') { echo 'class="open active"'; } ?>> <a class="uif-navigationActionLink" href="prop-budget.php"><span class="icon-money"></span><span class="uif-innerText">Budgets</span></a> </li>
