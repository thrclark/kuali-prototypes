...
<div id="modal-add-compliance" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel">Add Compliance Protocol</h4>
            </div>
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="protocolnumber" name="protocolnumber">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="apprdate" name="apprdate">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-footer">
                <div class="clearfix">
                    <a href="prop-compliance-1.php" class="btn btn-primary pull-left">Add Compliance Protocol</a>
