                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="details">
                            <div class="uif-header-inner">
                                <h3 id="" class="uif-headerText"> <span class="uif-headerText-span"> Details </span> </h3>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Role:</label>
                                <div class="col-sm-3">
                                    <p class="form-control-static">Principal Investigator</p>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="tab-pane" id="periods">
                            <div class="uif-header-inner">
                                <h3 id="" class="uif-headerText"> <span class="uif-headerText-span"> Salary by Period </span> </h3>
                            </div>
                            <div class="alert alert-info alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                <strong>Note - </strong> The information here will only be used for system-to-system submissions only. </div>
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <tr>
                                        <td><div class="col-sm-1">1</div></td>
                                        <td><div class="col-sm-3">
                                                <label for="period_p1_s1"><span class="sr-only">Period 1 salary</span></label>
                                                <input type="text" class="input-sm text-right" value="$0.00">
                                            </div></td>
                                    </tr>
                                    <tr>
                                        <td><div class="col-sm-1">2</div></td>
                                        <td><div class="col-sm-3">
                                    ...
                                    <tr>
                                        <td><div class="col-sm-1">3</div></td>
                                        <td><div class="col-sm-3">
                                    ...
                                    <tr>
                                        <td><div class="col-sm-1">4</div></td>
                                        <td><div class="col-sm-3">
                                    ...
                                    <tr>
                                        <td><div class="col-sm-1">5</div></td>
                                        <td><div class="col-sm-3">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><div class="col-sm-2"> <a href="#" class="btn btn-xs btn-default">Recalculate</a> </div></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
