    ...
    <div id="LabsProposal" class="clearfix uif-formView" data-role="View"> <!-- BREADCRUMBS --><!-- VIEW HEADER --> 
        ...
        <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container-fluid"><!-- VIEW NAVIGATION -->
            ...
            <main id="" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="" style="margin-left: 250px;">
                <div class="uif-header-inner">
                    <h2 id="" class="uif-headerText"> <span class="uif-headerText-span"> Assign Personnel to Periods </span> </h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 uif-pagetools ">
                                        <div class="btn-group pull-right">
                                            <button type="button" class="btn btn-default btn-xs">Calculate Current Period</button>
                                            <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#persperiod">Assign Personnel...</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-condensed table-bordered uif-has-actions uif-lightTable dataTable" id="Demo-LightTableGroup1_lightTable" aria-describedby="Demo-LightTableGroup1_lightTable_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class=""  role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" colspan="1" aria-label="Field 4: : activate to sort column ">Charged</th>
                                            <th class=""  role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" aria-label="Field 4: : activate to sort column ">Period Type</th>
                                            <th class=""  role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" aria-label="Field 4: : activate to sort column ">Requested Salary</th>
                                            <th class=""  role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" aria-label="Field 4: : activate to sort column ">Calculated Fringe</th>
                                    ...
                                    <tbody>
                                        <tr class="active">
                                            <th colspan="9"> <span class="uif-headerText pull-left" >Faculty Salaries - Tenured</span> <a href="#" class="uif-actionLink pull-right" data-toggle="modal" data-target="#details">Details &amp; Rates</a> </th>
                                        </tr>
                                        <tr>
                                            <td>Ward Cleaver <small class="text-muted">(PI)</small></td>
                                            <td><span data-edit-type="input">1/12/14</span></td>
                                            ...
                                            <td><div class="dropdown dropdown-large"> <a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-edit-assigned-personnel-01">Details</a> <a href="#" class="btn btn-default btn-xs uif-delete"><span class="sr-only">Delete</span><span class="icon icon-trash"></span></a> </div></td>
                                        </tr>
                                        <tr class="active">
                                            <th colspan="9"> <span class="uif-headerText pull-left" >Post Doctoral Staff</span> <a href="#" class="uif-actionLink pull-right" data-toggle="modal" data-target="#details">Details &amp; Rates</a> </th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="active">
                                            <th colspan="9"> <span class="uif-headerText pull-left" >Summer Faculty</span> <a href="#" class="uif-actionLink pull-right" data-toggle="modal" data-target="#details">Details &amp; Rates</a> </th>
                                        </tr>
                                        <tr>
        ...
        <div id="" class="uif-footer clearfix uif-stickyFooter uif-stickyButtonFooter" data-sticky_footer="true" data-parent="LabsProposal" style="position:fixed; left: 0; bottom: 0px;">
            <div class="global-navigate btn-group">
                <button type="button" href="bud-personnelCosts-projPersonnel1.php" id="" class="btn btn-default"><span class="icon-chevron-left"></span> Back</button>
                <button type="button" href="bud-non-personnel.php" id="save-continue" class="btn btn-primary save-continue-btn">Continue <span class="icon-chevron-right"></span></button>
...
<script>
        (function($){
            ...
            $('body').on('click','.save-continue-btn', function(e) {
                ...
                document.location.href='bud-non-personnel.php?modular-budget=no&amp;detail=yes';
...
<?php include('includes/modals-budget/addPersPeriod.php') ?>
<!-- MODAL edit personnel details -->
<?php include ('includes/modals-budget/edit-assigned-personnel-01.php') ?>
