...
<div class="uif-footer clearfix uif-stickyFooter uif-stickyButtonFooter" data-sticky_footer="true" data-parent="LabsProposal" style="position:fixed; left: 0; bottom: 0px;">
    ...
    <div class="global-navigate btn-group">
        <button type="button" href="coi-screening-questions.php" class="btn btn-default">
            <span class="icon-chevron-left">

            </span>
            Back
        </button>
        <button type="button" href="coi-relationships.php" id="save-continue" class="btn btn-primary">
            Continue 
