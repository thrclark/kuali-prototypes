...
maxLengthConditional: 'Must be at most {0} characters'});});if (actionDefaults == undefined) {
        ...
        <main id="" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="" style="margin-left: 250px;">
            ...
            <!--<div class="alert alert-info fade in" role="alert">
                ...
                <p><strong>Data Overrides by Reviewer</strong> - Upon institutional review, the following item(s) have been overridden:</p>
                <ul style="list-style:inherit; padding:inherit">
                    <li> Proposal Type has been changed from Resubmission to Renewal</li>
                    <li> Activity Type has been changed from Public Service to Student Services</li>
                </ul>
                <p>View a comlete summary of all data overrides for this proposal <a href="#" data-toggle="modal" data-target="#modal-dataoverrides">here</a>.</p>
            </div>-->
            <section id="" class="multi-columns-row uif-cssGridGroup uif-boxLayoutVerticalItem clearfix form-horizontal" data-parent="">
                ...
                <div class="col-md-8">
                    <div id="" class="uif-inputField" data-parent="" data-role="InputField" data-label="">
                        ...
                        <a href="#" class="uif-actionLink kc-data-override" tabindex="0" data-role="Action" data-toggle="modal" data-target="#modal-dataoverrides"> <span class="icon-pencil2"><span class="sr-only">Overridden</span> </span></a> </div>
                </div>
                <div class="md-clear-left col-md-2 uif-cssGridLabelCol">
                ...
                <div class="col-md-8">
                    <div id="" class="uif-inputField" data-parent="" data-role="InputField" data-label="">
                        <textarea id="uahyfb8_control" name="inputField2" rows="3" cols="40" class="form-control input-sm uif-textAreaControl valid" data-role="Control" data-control_for="uahyfb8" data-original-title="" title="" data-hastooltip="true"></textarea>       <a href="#" class="uif-actionLink kc-data-override" tabindex="0" data-role="Action" data-toggle="modal" data-target="#modal-dataoverrides"> <span class="icon-pencil2"><span class="sr-only">Overridden</span> </span></a> 
                    </div>
                </div>
                <div class="md-clear-left col-md-2 uif-cssGridLabelCol">
