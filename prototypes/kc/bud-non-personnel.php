                        ...
                        <section class="clearfix">
                            <div>
                                <table class="table table-condensed table-bordered uif-has-actions uif-lightTable dataTable" id="Demo-LightTableGroup1_lightTable" aria-describedby="Demo-LightTableGroup1_lightTable_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="" role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Field 1: : activate to sort column "><label id="urh9zx8" class="uif-label">Object Code Name</label></th>
                                            <th class="" role="columnheader" tabindex="0" aria-controls="Demo-LightTableGroup1_lightTable" rowspan="1" colspan="1" aria-label="Field 2: : activate to sort column ">Description</th>
                                    ...
                                    <tbody>
                                        <tr class="active">
                                            <th colspan="5"> <span class="uif-headerText pull-left">Equipment</span> </th>
                                        </tr>
                                        <tr>
                                            <td>Equipment Rental - Not MTDC</td>
                                            <td>Microscope</td>
                                        ...
                                        <tr>
                                            <td>Fabricated Equipment - Not MTDC</td>
                                            <td>Apples</td>
                                        ...
                                        <tr class="active">
                                            <th colspan="5"><span class="uif-headerText pull-left">Travel</span></th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="active">
                                            ...
                                            <span class="uif-headerText pull-left">Participant Support</span> <span class="pull-right" style=" font-weight:normal">3 Participants (<a href="#" data-toggle="modal" data-target="#participant">edit</a>)</span>
                                        ...
                                        <tr>
                                            <td>Participant Cost - tuition</td>
                                            <td>Tuition</td>
                                            <td class="text-right">3</td>
                                            <td>3000.00</td>
                                            <td><div class="dropdown dropdown-large"> <a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-edit-assigned-non-personnel-01">Details</a> <a href="#" class="btn btn-default btn-xs uif-delete"><span class="sr-only">Delete</span><span class="icon icon-trash"></span></a></div></td>
                                        ...
                                        <tr>
                                            <td>Tuition PreDoc Trainee Dual Degree</td>
                                            <td>Tuition</td>
                                            <td class="text-right">3</td>
                                            <td>3000.00</td>
                                            <td><div class="dropdown dropdown-large"> <a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-edit-assigned-non-personnel-01">Details</a> <a href="#" class="btn btn-default btn-xs uif-delete"><span class="sr-only">Delete</span><span class="icon icon-trash"></span></a></div></td>
                                        ...
                                        <tr>
                                            <td>Computer Supplies and Peripherals</td>
                                            <td>Mouse pads</td>
...
<?php include('includes/modals-budget/complete.php') ?>

<?php include('includes/modals-budget/participant.php') ?>
