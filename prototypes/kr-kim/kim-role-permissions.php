...
<!-- GLOBAL MODALS -->
<?php
include ('includes/modal-data-validation.php');
include ('includes/toolbar-print.php');
include ('includes/toolbar-copy.php');
include ('includes/toolbar-medusa.php');
include ('includes/toolbar-hierarchy.php');
include ('includes/toolbar-access.php');
include ('includes/toolbar-access-add.php');
include ('includes/toolbar-access-results.php');
include ('includes/toolbar-access-added.php');
?>
