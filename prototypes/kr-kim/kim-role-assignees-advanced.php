        ...
        <main id="LabsProposal-Page" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left: 250px;">
            <header class="clearfix uif-header-contentWrapper">
                <div class="uif-pageHeader clearfix" data-header_for="LabsProposal-Page">
                    <h2 class="uif-headerText"> <span class="uif-headerText-span"> Assignees </span> <a href="#" class="btn btn-default btn-xs pull-right" tabindex="0" data-role="Action" data-toggle="modal" data-target="#modal-assignee-add-advanced"><span aria-hidden="true" class="icon-plus"></span> Add Assignee</a> </h2>
                </div>
            </header>
...
<?php include ('includes/modal-assignee-add-advanced.php') ?>
>
</body>
</html>