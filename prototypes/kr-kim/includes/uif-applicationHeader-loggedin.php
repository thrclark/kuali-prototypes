...
<header id="Uif-ApplicationHeader-Wrapper" data-sticky="true" class="uif-sticky" style="position:fixed; left: 0; top: 0px;">
    <div class="uif-applicationHeader">
        <div class="container">
            <nav  class="navbar" role="navigation">
                <div class="navbar-header">
                    ...
                    <div class="logoBrand">
                        <h1 class="uif-brand"><span class="sr-only">Kuali KRAD</span></h1>
                    </div>
                </div>
                <div class="collapse navbar-collapse navbar-ex1-collapse uif-listGroup">
                    <ul class="nav navbar-nav navbar-right uif-listLayout">
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Main Menu </a>
                            <div class="row multi-columns-row dropdown-menu uif-cssGridGroup">
                                <div class="col-md-6">
                            ...
                            <div class="row multi-columns-row dropdown-menu uif-cssGridGroup">
                                ...
                                <div class="col-md-4">
                                    <section class="uif-listGroup">
                                        ...
                                        <ul class="uif-listLayout">
                                            <li class="hoverDisclose"> Person<span class="disclose pull-right"> <a href="lookup-person.php" title="Person">Lookup</a> | <a href="kim-person-docoverview.php">Add</a></span> </li>
                                            <li class="hoverDisclose"> Group<span class="disclose pull-right"> <a href="lookup-group.php" title="Person">Lookup</a> | <a href="kim-group.php">Add</a></span> </li>
                                            <li class="hoverDisclose"> Role<span class="disclose pull-right"> <a href="lookup-role.php" title="Person">Lookup</a> | <a href="kim-role-docoverview.php">Add</a></span> </li>
                                            <li class="hoverDisclose"> Permission<span class="disclose pull-right"> <a href="#" title="Person">Lookup</a> | <a href="#">Add</a></span> </li>
                                            <li class="hoverDisclose"> Responsibility<span class="disclose pull-right"> <a href="#" title="Person">Lookup</a> | <a href="#">Add</a></span> </li>
                                        </ul>
        ...
        <?php include ('../cross-project/includes/toolbar-fixed.php') ?>
    </div>
</header>
