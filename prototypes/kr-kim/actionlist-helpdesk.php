                ...
                <header>
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right" style="padding-top:20px">
                            <div class="input-group hidden-xs" style="position: absolute;bottom: 0px;right: -15px;margin-bottom: -30px;">
                                <input type="text" class="form-control input-sm" placeholder="Help Desk " style="height: 22px;width: 100px;">
                                <span class="input-group-btn">
                                <button class="btn btn-default" type="button" style="height: 22px;line-height: 2px;font-size: 12px;margin-right: 22px;"> Login </button>
                                </span> </div>
                            <a class="uif-actionLink" tabindex="0" data-role="Action" data-toggle="modal" data-target="#actionlist-prefs" data-submit_data="" data-dismiss="modal"> <span aria-hidden="true" class="icon-cog" style="color:#999"></span> Preferences</a></div>
                    </div>
                </header>
