        ...
        <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container"><!-- VIEW NAVIGATION -->
            ...
            <main id="LabsProposal-Page" class="uif-page" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left:;">
                <header class="clearfix uif-header-contentWrapper">
                    <div id="" class="uif-pageHeader clearfix" data-header_for="LabsProposal-Page">
                ...
                <div class="form-horizontal" role="form">
                    ...
                    <div class="row ">
                        <div class="col-md-7" >
                            <div class="row">
                                <div class="col-xs-6">
                                    <h4 style="margin-top:0px"> Advanced Search</h4>
                                </div>
                                <div class="col-xs-6 text-right"> <a href="docsearch.php">(Basic)</a></div>
                            </div>
                            <div class="well uif-form">
                                ...
                                <div class="form-group">
                                    <label for="appdocID" class="col-md-4 control-label">Application Document ID</label>
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" placeholder="" id="appdocID">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="title" class="col-md-4 control-label">Title</label>
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" placeholder="" id="title">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="approver" class="col-md-4 control-label">Approver</label>
                                    <div class="col-md-7">
                                        <div class="uif-form-control input-group">
                                            <input type="text" class="form-control" id="approver" name="test-username-2" value="" style="background-image:none" required>
                                            <div class="input-group-btn"> 
                                                <!-- Lookups, datepickers, etc. --> 
                                                <a href="#"  data-role="Action" data-toggle="modal" data-target="#lookup" data-submit_data="" data-dismiss="modal" class="uif-actionLink btn btn-default uif-action icon-search"></a> 
                                                <!-- // --> 
                                ...
                                <div class="form-group">
                                    <label for="viewer" class="col-md-4 control-label">Viewer</label>
                                    <div class="col-md-7">
                                        <div class="uif-form-control input-group">
                                            <input type="text" class="form-control" id="viewer" name="test-username-2" value="" style="background-image:none" required>
                                            <div class="input-group-btn"> 
                                                <!-- Lookups, datepickers, etc. --> 
                                                <a href="#"  data-role="Action" data-toggle="modal" data-target="#lookup" data-submit_data="" data-dismiss="modal" class="uif-actionLink btn btn-default uif-action icon-search"></a> 
                                                <!-- // --> 
                                ...
                                <div class="form-group">
                                    <label for="groupviewerID" class="col-md-4 control-label">Group Viewer ID</label>
                                    <div class="col-md-7">
                                        <div class="uif-form-control input-group">
                                            <input type="text" class="form-control" id="groupviewerID" name="test-username-2" value="" style="background-image:none" required>
                                            <div class="input-group-btn"> 
                                                <!-- Lookups, datepickers, etc. --> 
                                                <a href="#"  data-role="Action" data-toggle="modal" data-target="#lookup" data-submit_data="" data-dismiss="modal" class="uif-actionLink btn btn-default uif-action icon-search"></a> 
                                                <!-- // --> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <div class="uif-form-control input-group">
                                            <input type="text" class="form-control" name="test-username-2" value="" id="initiator">
                                            <div class="input-group-btn"> 
                                                <!-- Lookups, datepickers, etc. --> 
                                                <a href="#" class="uif-actionLink btn btn-default uif-action icon-search"></a> 
                                                <!-- // --> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Finalized Date</label>
                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="col-xs-4 col-sm-4">
                                                <input type="text" class="form-control" placeholder="mm/dd/yyyy">
