...
<form  action="http://jquery-file-upload.appspot.com" method="POST" enctype="multipart/form-data">
 ...
 Actions " role="columnheader"> <label  class="clearfix infoline"> Actions </label></th>
                    ...
                    <div class="uif-uploading">
                        <div class="progress progress-striped active">
                            <div class="progress-bar"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 15%;"> <span class="sr-only">45% Complete</span> </div>
                        </div>
                        
                        <div class="text-center"> <a href="#" class="btn btn-default">Cancel Upload</a> </div>
                    </div>
                </div>
            </main>
        </div>
